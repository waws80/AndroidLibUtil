...
object RegexConstants {
     ...
     * 正则：密码 6-18位
     */
    const val REGEX_PASSWORD = "^(?![\\d]+\$)(?![a-zA-Z]+\$)(?![^\\da-zA-Z]+\$).{6,18}\$"

    /**
     * 正则：密码
     */
    @JvmStatic
    fun  regexPassword(min: Int = 6, max: Int = 16) = "^(?![\\d]+\$)(?![a-zA-Z]+\$)(?![^\\da-zA-Z]+\$).{$min,$max}\$"
    /**
     * 正则：手机号（简单）
     */
     ...
     * 虚拟运营商：170
     */
    const val REGEX_MOBILE_EXACT = "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0-9])|(18[0-9])|(147))\\d{8}$"
    /**
     * 正则：电话号码
     */
